<template>
	<main>
	<header>
		<img @click="back" src="../../assets/image/back.png">
		<h1>用户协议</h1>
	</header>
	<p>软件用户许可安装协议

用户须知：在此特别提醒各位用户认真阅读、充分理解本《软件许可及安装协议》（下称《协议》）——用户应认真阅读充分理解本《协议》中各条款。您的安装、使用、获取和登录XXXapp等行为将视为对本《协议》的接受，并同意接受本《协议》各项条款的约束。

本《协议》是您（下称“用户”）与公司之间关于用户安装、使用软件，注册、使用、管理软件；以及使用公司公司提供的相关服务所订立的协议。本《协议》描述公司与用户之间关于“软件”许可使用及服务相关方面的权利义务。“用户”是指通过公司提供的获取软件授权和XXX注册的途径获得软件产品及号码授权许可以及使用公司公司提供的相关服务的个人或组织。
...
2.1用户可以在个人计算机或者手机上安装、使用、显示、运行本软件。
...
3.1用户可以通过预约功能体验公司提供的各种服务。

包括在各大门店体验艾灸仪等各类专业养生仪器。

3.2 用户可以通过在线购买方式获得本公司各类产品。在线支付支持各大银行网银和快捷支付，支付宝、微信等支付方式。

3.3用户可以通过在线申请方式加入XXX，成为XXX的会员。会员可享受优惠价格购买产品和免费门店体验服务。会员实行积分制度，每次消费满人民币一百元及以上即可享受一次积分，不满一百元的部分不计入积分。积分可以多次消费累积，上不封顶。积分可以在各大门店换取免费美容保养项目，积分当年有效，次年清零。会员实行一人卡号制度，会员服务仅限本人使用，不得转借他人。

3.4用户可以申请成为XXX的代理人，享受会员待遇。代理人须遵守本协议，实行自愿原则。
...
用于中华人民共和国法律。若用户和公司之间发生任何纠纷或争议，首先应友好协商解决，协商不成的，用户在此完全同意将纠纷或争议提交公司公司所在地即北京有管辖权的人民法院管辖。

5.3本《协议》版权由公司所有，公司保留一切解释权利。本文中提及的软件和服务名称有可能为公司的注册商标或商标，受法律保护。</p>
	</main>
</template>
